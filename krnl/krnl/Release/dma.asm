; Listing generated by Microsoft (R) Optimizing Compiler Version 14.00.50727.762 
	...
	TITLE	i:\os\10\a\krnl\krnl\dma.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File i:\os\10\a\krnl\krnl\dma.cpp
...
; 8    : 		outportb(DMA0_CHANMASK_REG, (1 << (channel-1)));
...
; 9    : 	else
; 10   : 		outportb(DMA1_CHANMASK_REG, (1 << (channel-5)));
...
; 17   : 		outportb(DMA0_CHANMASK_REG, channel);
...
; 18   : 	else
; 19   : 		outportb(DMA1_CHANMASK_REG, channel);
...
; 26   : 	outportb(DMA1_UNMASK_ALL_REG, 0xff);
...
; 33   : 	outportb(DMA0_TEMP_REG, 0xff);
...
; 43   : 	outportb( (dma==0) ? DMA0_CLEARBYTE_FLIPFLOP_REG : DMA1_CLEARBYTE_FLIPFLOP_REG, 0xff);
...
; 98   : 	outportb ( (channel < 4) ? (DMA0_MODE_REG) : DMA1_MODE_REG, chan | (mode) );

	or	bl, BYTE PTR _mode$[esp+8]
	add	esp, 8
	cmp	BYTE PTR _channel$[esp], 4
	sbb	eax, eax
	and	eax, -203				; ffffff35H
